...
GT = GT.img;
DMMS = load_nii('C:\Users\bcc\Desktop\BMCevaluation\AllResults\3DMMS\AfterUni\membSegUni74.nii');
DMMS = DMMS.img;
labels = unique(GT(:));
labels(labels == 0)= [];
...
save_file = 'C:\Users\bcc\Desktop\BMCevaluation\AllResults\3DMMS\membt074s.nii';
